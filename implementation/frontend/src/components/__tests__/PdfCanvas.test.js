...
const baseViewport = { scale: 1, tx: 0, ty: 0, rotationDeg: 0 };
function renderPdf(opts = {}) {
    ...
    return {
        onSelect,
        ...render(_jsx(PdfCanvas, { file: makeFile(), pageSizePt: [612, 792], result: result, selectedId: opts.selectedId ?? null, grayscale: false, viewport: baseViewport, onViewportChange: () => { }, onSelect: onSelect, onRotate: () => { }, onZoomBy: () => { } })),
    };
}
describe("PdfCanvas", () => {
